        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                InkWell(
                  ...
                  child: _buildMenuButton('assets/img/job.png', "চাকরি"),
                ),
                InkWell(
                  onTap: () => Get.to(VipJobListPage()),
                ...
                InkWell(
                  onTap: () => Get.to(LoanListPage()),
                  child: _buildMenuButton('assets/img/loan.png', "লোন স্কিম"),
                ),
              ],
            ),
            const SizedBox(height: 15),
            Row(
              ...
              children: [
                InkWell(
                  onTap: () => Get.to(DoctorListPage()),
                  child: _buildMenuButton('assets/img/doctor.png', "ডাক্তার"),
                ),
                InkWell(
                  onTap: () => Get.to(TicketListPage()),
                  child: _buildMenuButton(
                    'assets/img/ticket.png',
                    "বিমান টিকিট",
                  ),
                ),
                _buildMenuButton('assets/img/job-offer.png', "চাকরি দিবো"),
              ],
            ),
            const SizedBox(height: 15),
            Row(
              ...
              children: [
                InkWell(
                  onTap: () => Get.to(LigalHelpListPage()),
                  child: _buildMenuButton(
                    'assets/img/legal-advice.png',
                    "আইনি সহায়তা",
                  ),
                ),
                _buildMenuButton('assets/img/application.png', "এজেন্ট আবেদন"),
                InkWell(
                  onTap: () => Get.to(BenefitLitePage()),
                  child: _buildMenuButton(
            ...
            Row(
              ...
              children: [
                InkWell(
                  onTap: () => Get.to(NewsListPage()),
                  child: _buildMenuButton(
                    'assets/img/breaking-news.png',
                    "প্রবাস খবর",
                  ),
                ),
                _buildMenuButton('assets/img/agreement.png', "চুক্তিপত্র"),
                InkWell(
                  onTap: () => Get.to(PackagesPage()),
                  child: _buildMenuButton(
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceAround,
              children: [
                _buildMenuButton('assets/img/wallet.png', "রেফার-ইনকাম"),
                InkWell(
                  onTap: () => Get.to(VideoListPage()),
                  child: _buildMenuButton('assets/img/video.png', "শর্ট ভিডিও"),
                ),
                InkWell(
